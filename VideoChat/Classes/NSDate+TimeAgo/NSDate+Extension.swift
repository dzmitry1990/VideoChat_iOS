    ...
    public var timeAgo: String {
        ...
        if components.hour! > 0 {
            if components.hour! < 2 {
                ...
                return self.string(fromFormat: "%%d %@h ago", withValue: components.hour!)
            }
        }
        ...
        if components.minute! > 0 {
            if components.minute! < 2 {
                ...
                return self.string(fromFormat: "%%d %@min ago", withValue: components.minute!)
            }
        }
        ...
        if components.second! > 0 {
            if components.second! < 5 {
                ...
                return self.string(fromFormat: "%%d %@s ago", withValue: components.second!)
            }
        }
